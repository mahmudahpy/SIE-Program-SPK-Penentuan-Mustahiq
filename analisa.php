...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
			  ...
			  <li class="active" style=" font-family:'arial black'"><a href="#">Analisa</a></li>
      ...
      <div class="panel panel-primary" style=" font-family:'Bookman Old Style'">
		  ...
		  <div class="panel-heading" style="font-size:18px"><b>Analisa</b></div>
		  ...
		  <div class="panel-footer text-primary"><b><?php echo $_SESSION['by'];?></b><div class="pull-right"></div></div>
		</div>
